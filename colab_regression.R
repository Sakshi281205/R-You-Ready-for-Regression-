# =============================================================================
# R REGRESSION ANALYSIS: Data Science Toolkit (Colab Version)
# =============================================================================
# This script demonstrates real-world regression analysis using R's built-in datasets
# Modified for Google Colab - plots display inline instead of saving as PNG
# =============================================================================
...
# Create correlation plot (display inline)
...
# Create diagnostic plots (display inline)
...
cat("✅ All plots displayed inline in Colab\n")

cat("\nPlots created:\n")
cat("- MTCARS Correlation Matrix\n")
cat("- MTCARS Diagnostic Plots (4-panel)\n")
cat("- MTCARS Scatter Plot (MPG vs Weight)\n")
cat("- MTCARS Residual Plot\n")
cat("- IRIS Diagnostic Plots (4-panel)\n")
cat("- IRIS Scatter Plot (Petal Length vs Petal Width)\n")
cat("- IRIS Residual Plot\n")
